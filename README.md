# Monad Blitz Abuja Submission Process

## Steps to prepare your project repo:

1. Visit the `monad-blitz-abuja` repo (link [here](https://github.com/monad-developers/monad-blitz-abuja)) and fork it.

![fork](./screenshot/1.png)
